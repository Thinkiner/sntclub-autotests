// ============================================================
// E2E тест: Голосование на сайте testdev.sntclub.ru
...
async function login(page) {
  ...
  console.log('  → Открываем страницу авторизации https://testdev.sntclub.ru/ ...');
  await page.goto('https://testdev.sntclub.ru/', {
...
test('Голосование: открыть форму организации собрания', async ({ page }) => {
  ...
  await page.goto('https://testdev.sntclub.ru/votes/?new=Y', {
    waitUntil: 'domcontentloaded',
  });
  ...
  //    не определена на testdev, поэтому поля повестки (AGENDA_*) опциональны.
  ...
  // Ждём до 5 секунд для AJAX (на testdev addAgendaItemFunc может не быть определена)
  await page.waitForTimeout(3_000);

  // Ищем поле вопроса повестки (опционально — на testdev может не появиться)
  let agendaItemField;
  ...
  // ── 5. Описание рассмотрения (опционально на testdev) ─────────
  ...
  // Ждём до 15 сек — testdev может быть медленнее production
